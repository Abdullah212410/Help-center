...
/**
 * Route guard that only renders children when the current user is a teacher or admin.
        ...
        <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Please sign in with a teacher or admin account to write blog posts.
            </p>
            <Link
              to="/login"
      ...
      <Layout>
        <div className="min-h-[60vh] flex items-center justify-center px-4 py-16">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Only teachers and admins can create and edit blog posts.
            </p>
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-200"
