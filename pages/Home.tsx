...
export default function Home() {
  // Option A: Render "For Schools and Districts" directly on the home route
  const categorySlug = 'for-schools-and-districts';
    ...
    return (
       <Layout>
         <div className="container mx-auto px-4 py-12 text-center text-red-600">
            Error: Category "{categorySlug}" not found in data.
         </div>
       </Layout>
    );
  }
